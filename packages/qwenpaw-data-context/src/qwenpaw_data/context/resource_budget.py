    ...
    def from_env(cls) -> "ResourceLimits":
        return cls(
            request_timeout_seconds=_positive_float(
                "QWENPAW_DATA_REQUEST_TIMEOUT_SECONDS", 120.0
            ),
            max_upload_bytes=_positive_int("QWENPAW_DATA_MAX_UPLOAD_MB", 50)
            * 1024
            * 1024,
            max_response_bytes=_positive_int("QWENPAW_DATA_MAX_RESPONSE_MB", 50)
            * 1024
            * 1024,
            max_sql_rows=_positive_int("QWENPAW_DATA_MAX_SQL_ROWS", 10_000),
            max_cypher_rows=_positive_int("QWENPAW_DATA_MAX_CYPHER_ROWS", 1_000),
            max_graph_nodes=_positive_int("QWENPAW_DATA_MAX_GRAPH_NODES", 5_000),
            max_graph_edges=_positive_int("QWENPAW_DATA_MAX_GRAPH_EDGES", 20_000),
            max_llm_tokens=_positive_int("QWENPAW_DATA_MAX_LLM_TOKENS", 32_768),
            max_llm_retries=_positive_int("QWENPAW_DATA_MAX_LLM_RETRIES", 4),
            max_external_concurrency=_positive_int(
                "QWENPAW_DATA_MAX_EXTERNAL_CONCURRENCY", 16
            ),
        )
