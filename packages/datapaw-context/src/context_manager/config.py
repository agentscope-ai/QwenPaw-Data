...
from datapaw.context.paths import kg_documents_dir, sessions_db_path as _datapaw_sessions_db

# src/context_manager/config.py 上溯三级 = 包根（packages/datapaw-context）。
...
def _doc_storage_dir_default() -> str:
    """KG documents 默认落到 ``${DATAPAW_HOME}/data-bridge/kg/documents``。"""
