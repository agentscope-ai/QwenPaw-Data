"""Shared DataPaw dotenv resolution."""
...
def datapaw_env_file() -> Path:
    """Return the configured DataPaw env file path."""
...
def load_datapaw_env(*, override: bool = False) -> Path:
    """Load the DataPaw env file without consulting package-local env files."""
