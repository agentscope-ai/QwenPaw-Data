...
Complements :mod:`qwenpaw_data.host.core.cm_client` (read-only discovery) with the
...
_AUTH_HINT = (
    "hint: set QWENPAW_DATA_CLIENT_API_TOKEN (or QWENPAW_DATA_API_TOKEN) with the "
    "required scope"
)
