...
from .agent import DataPawAgent
from .agent.toolkit import build_datapaw_toolkit
...
class DataPawHost:
    ...
    def __init__(
        ...
        *,
        ...
        self._agent: DataPawAgent | None = None
