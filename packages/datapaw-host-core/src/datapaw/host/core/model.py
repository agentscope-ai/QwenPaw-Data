...
_PROVIDER_ENV = "DATAPAW_MODEL_PROVIDER"
_MODEL_ENV = "DATAPAW_MODEL_NAME"
_API_KEY_ENV = "DATAPAW_MODEL_API_KEY"
_BASE_URL_ENV = "DATAPAW_MODEL_BASE_URL"
...
def build_model_from_env(
    ...
    if missing:
        raise RuntimeError(
            "DataPaw model is not configured; pass model=... to "
            "DataPawHost(...) "
            "or set "
            + ", ".join(missing)
            + ".",
